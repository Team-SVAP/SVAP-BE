...
public class QReport extends EntityPathBase<Report> {
    ...
    private static final long serialVersionUID = 997898094L;
    ...
    public final DatePath<java.time.LocalDate> reportTime = createDate("reportTime", java.time.LocalDate.class);

    public final StringPath whoReported = createString("whoReported");
